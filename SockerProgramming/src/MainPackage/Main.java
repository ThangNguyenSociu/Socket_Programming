...
>>>>>>> branch 'main' of https://github.com/ThangNguyenSociu/Socket_Programming.git
	...
	private void TrangChu() {
		...
		studentInfoPanel.add(createLabelStudent("Phạm Nhựt Huy - 52300030"));
...
>>>>>>> branch 'main' of https://github.com/ThangNguyenSociu/Socket_Programming.git
	...
	private void actionGoToPageUDP(JButton button) {
		button.addActionListener(e -> {
			System.out.println("Đang chuyển sang trang chủ UDP");
			new UDPMenu(this).setVisible(true);
			this.setVisible(false);
		});
	}
